...
//   position: 'relative', // Needed for absolute positioning of coins
// });
...
//   borderRadius: '50%',
//   filter: 'blur(1px)',
//   pointerEvents: 'none', // Make coins non-interactive
// });
...
//         while (1) {
//           await next({
//             top: `${Math.max(0, Math.min(90, Math.random() * 100))}%`, // Keep within viewport
//             left: `${Math.max(0, Math.min(90, Math.random() * 100))}%`, // Keep within viewport
//             opacity: 0.7,
//             config: { duration: 5000 + Math.random() * 5000 }
//           });
//           await next({
...
// Removed Particles component since we're using FloatingCoins directly
