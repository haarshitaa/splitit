...
export function Friends({ friends, loadfriend, currentUser }) {
  ...
  return (
    <div className="flex h-[calc(100vh-2rem)] w-full p-4 gap-4"> {/* Adjusted height */}
      ...
      <div className="w-80 flex flex-col bg-white rounded-lg shadow-md">
        <div className="p-4">
        ...
        <div className="flex-1 overflow-y-auto px-4 pb-4"> {/* Added padding and overflow */}
          {loadfriend ? (
            ...
            <div className="space-y-2">
              {friends.map((friend) => (
                <div 
                  ...
                  className={`border p-3 rounded-lg cursor-pointer hover:bg-gray-50 transition ${
  ...
  //       {/* Left side - User and friend details */}
  //       <div className="flex-1 bg-white rounded-lg shadow-md p-6 flex flex-col">
  //         {/* ... (keep your existing left side content) ... */}
  //       </div>
